...
class FinalizeJuneAndJulySalesCommand extends Command
{
    protected $signature = 'laijau:finalize-jun-jul-sales {--dry-run : Run simulation without writing to database} {--live : Run live database updates}';
    protected $description = 'Full audit and finalization of June and July showroom sales: distribute undated sales across Jun 1-30 and Jul 1-31, standardize Walk-in Customer names, standardize cash vs fonepay, and sync Bikri Khata & GL';
    ...
    public function handle(): int
    {
        ...
        $this->info('========================================================================');
        $this->info('  LAIJAU ERP — JUNE & JULY SHOWROOM SALES COMPLETE FINALIZATION');
        ...
        $this->info('========================================================================');
        $this->info('  JUNE & JULY SALES FINALIZATION COMPLETED SUCCESSFULLY');
        $this->info('========================================================================');
