<x-filament-panels::page class="w-full max-w-full !p-0">
    ...
    <div class="lj-pos-root lj-pos-admin-shell-page" style="display: flex; flex-direction: column; gap: 0.75rem;">
        ...
        <!-- Modals required by History: Sale Detail, Void Sale, Receipt -->
        @include('filament.pages.offline-sales.modals.sale-detail')
        @include('filament.pages.offline-sales.modals.void-sale')
        @include('filament.pages.offline-sales.modals.receipt')
    </div>
